...
function s:AddTitle()
    ...
    let lastLine = line('.')
    normal o
    call setline('.',noTypeChar.preChar.' 	   Descriptions:')
    let gotoLn = line('.')
    normal o
    call setline('.',noTypeChar.' *')
    let lastLine = line('.')
    ...
    normal o
    call setline('.',noTypeChar.preChar.'		   Revision: '.'(none)')
    normal o
    call setline('.',noTypeChar.' *')
    let lastLine = line('.')
    normal o
    call setline('.',noTypeChar.preChar.'			 Author: '.g:vimrc_author.'('.g:vimrc_englishname.'), '.g:vimrc_email)
    normal o
    call setline('.',noTypeChar.preChar.'			Company: '.g:vimrc_company)
    normal o
    call setline('.',noTypeChar.' *')
    let lastLine = line('.')
    normal o
